...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            if (selectedTime.indexOf("Production-QC-XXXXX") > 1) {
                document.getElementById("ddlQcNo").disabled = true;
                document.getElementById("Dummy").disabled = false;
                qcdd.style.display = "none";
            }
            else if (selectedTime.indexOf("Fix-QC-XXXXX") > 1) {
                document.getElementById("ddlQcNo").disabled = true;
                document.getElementById("Dummy").disabled = false;
                qcdd.style.display = "none";
            }
            else if (selectedTime.indexOf("XXXXX") > 1) {
...
<body>
    ...
    <asp:Button ID="Button2" runat="server" class="login100-form-btn1" Text="Sat & Sun" />&nbsp;<cc1:ModalPopupExtender
        ID="mp1" runat="server" PopupControlID="Panl1" TargetControlID="Button2" CancelControlID="Button3"
    ...
    <asp:Panel ID="Panl1" runat="server" CssClass="Popup" align="center" Style="display: none">
        <iframe style="width: 1050px; height: 260px; background-color: white" id="irm1" src="SingleDateEntry.aspx"
            runat="server"></iframe>
    ...
    <div class="labelcss">
        ...
        &nbsp;&nbsp;<asp:ImageButton ID="btnPasswordChange" runat="server" Height="20px"
            Width="20px" ImageUrl="Content/password.png" title="change password" OnClick="btnPasswordChange_Click" />&nbsp;&nbsp;
        <asp:ImageButton ID="ImageBtnSerach" runat="server" Height="17px" Width="17px" ImageUrl="Content/sear.png"
            title="self report" OnClick="ImageBtnSerach_Click" />&nbsp;&nbsp;<asp:ImageButton
                ID="BtnLogOut" runat="server" Height="20px" Width="20px" ImageUrl="Content/logout.jpg"
                title="logout" OnClick="BtnLogOut_Click" /></div>
    <table frame="below" class="table tab-content table-bordered table-active">
        <tr class="table tab-content table-bordered table-active">
            ...
            <td class="style6">
                <asp:Label ID="lblHour1" runat="server" ClientIDMode="Static" Width="87px" Text="Mon"></asp:Label>
            </td>
            <td class="style6">
        ...
        <tr>
            ...
            <td class="style4">
                ...
                <asp:TextBox ID="Dummy" runat="server"></asp:TextBox>
            </td>
            <td class="style6">
        ...
        <tr>
            ...
            <td class="style14">
                <div class="container-login100-form-btn">
                    <asp:Button ID="btnAdd" runat="server" class="login100-form-btn1" OnClientClick="return validation()"
                        OnClick="btnAdd_Click" Text="Add to List" /></div>
                &nbsp;
            </td>
        </tr>
    </table>
    <div class="container-login100-form-btn">
        <asp:Button ID="Button1" runat="server" class="login100-form-btn1" OnClick="Button1_Click"
            Text="View Entry" />
    ...
    <asp:GridView ID="grd" runat="server" AutoGenerateColumns="false" CssClass="table tab-content table-bordered table-active table-hover"
        ...
        OnRowDataBound="grd_RowDataBound" OnRowDeleting="grd_RowDeleting" OnRowEditing="grd_RowEditing"
        OnRowUpdating="grd_RowUpdating" Style="margin-top: 94px;">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Date">
                ...
                <EditItemTemplate>
                    <asp:TextBox ID="textboxdate" runat="server" Height="24px" Text='<%#Eval("Date")%>'
            ...
            <asp:TemplateField HeaderText="Process">
                ...
                <EditItemTemplate>
                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="AccessDataSource1"
                        DataTextField="ProcessName" DataValueField="Process_ID" Height="24px" SelectedText='<%#Eval("ProcessName")%>'
                        SelectedValue='<%#Eval("Process_ID")%>'>
                    </asp:DropDownList>
                </EditItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="QCno">
                ...
                <EditItemTemplate>
                    ...
                    <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="AccessDataSource2"
                        DataTextField="QC_No" DataValueField="QC_No" Height="24px">
                    </asp:DropDownList>
                </EditItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Hours">
                ...
                <EditItemTemplate>
                    <asp:TextBox ID="textboxhours" runat="server" Height="24px" Style="text-align: right"
                        Text='<%#Eval("Hours")%>' Width="100px"></asp:TextBox>
                </EditItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Description">
                ...
                <EditItemTemplate>
                    <asp:TextBox ID="textboxdesc" runat="server" Height="24px" Text='<%#Eval("Description")%>'
                        Width="100px"></asp:TextBox>
                </EditItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="Linkbutton2" runat="server" CausesValidation="false" CommandName="Delete"
                        OnClientClick="return confirm('Are you sure to Delete the entry?');" Text="Delete"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    ...
    <div>
        <asp:HiddenField ID="hour1HiddenField" runat="server" />
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="C:\ProjectDatabase\MMTimeSheetDB.accdb"
        SelectCommand="SELECT ProcessName, Min(Process_ID) as Process_ID FROM Process Group
 BY  ProcessName"></asp:AccessDataSource>
    <asp:AccessDataSource ID="AccessDataSource2" runat="server" DataFile="C:\ProjectDatabase\MMTimeSheetDB.accdb"
        SelectCommand="SELECT [QC NO] AS QC_No FROM [EmpQcDetails] WHERE ([Emp NO] = (SELECT ID FROM Login WHERE UserName = ?) )">
        <SelectParameters>
            <asp:ControlParameter ControlID="txtUserName" Name="Emp_NO" PropertyName="Text" Type="String" />
        </SelectParameters>
