<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SingleDateEntry.aspx.cs"
    Inherits="WebApplication1.SingleDateEntry" %>
    ...
    <table frame="below" class="table tab-content table-bordered table-active">
        ...
        <tr>
            <td>
                ...
                <cc1:CalendarExtender ID="txtcal_CalendarExtender" runat="server" TargetControlID="txtSingleDate"
                    PopupButtonID="ImageButton1" />
                <asp:ImageButton ID="ImageButton1" runat="server" Height="22px" Width="37px" CausesValidation="False"
                    ImageAlign="Baseline" ImageUrl="~/n2NRo.png" TabIndex="2" />
            </td>
            </td>
            <td>
                <asp:DropDownList ID="ddlSingleProcess" runat="server">
                </asp:DropDownList>
            </td>
            <td>
                <asp:DropDownList ID="ddlSingleQc" runat="server">
                </asp:DropDownList>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnAdd" runat="server" class="login100-form-btn1" Text="Add to List"
                    OnClientClick="return validation()" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <div class="sample">
        <asp:Label ID="lblSingleMessage" runat="server" ForeColor="Red"></asp:Label></div>
    <script type="text/javascript" language="javascript">
